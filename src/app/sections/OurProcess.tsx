...
export default function AboutUs() {
  return (
    <section className="pt-8 pl-8 pb-20  bg-[radial-gradient(ellipse_50%_50%_at_center,#dbdeee,#EAEEFE_100%)] overflow-x-clip">
      ...
      <ul className="mt-[54px] divide-y divide-opacity-[0.7] h-[500px] px-[20px]">
          <li className="group relative flex flex-col justify-between px-[30px] py-[20px] lg:px-[120px] transition-all duration-500 ease-in-out hover:bg-grayLight">
            <div className="flex items-center">
              ...
              <h3 className="ml-[20px] text-[15px] xl:text-lg 2xl:text-lg text-gray-600 opacity-70 lg:text-[22px]">
                Innowacja i Kreatywność
              </h3>
            </div>
            <p className="mt-[10px] text-[14px] xl:text-lg 2xl:text-lg text-gray-700 opacity-0 group-hover:opacity-100 max-h-0 group-hover:max-h-[80px] overflow-hidden transition-all duration-500 ease-in-out">
          ...
          <li className="group relative flex flex-col justify-between px-[30px] py-[20px] lg:px-[120px] transition-all duration-500 ease-in-out hover:bg-grayLight">
            <div className="flex items-center">
              ...
              <h3 className="ml-[20px] text-[15px] xl:text-lg 2xl:text-lg text-gray-700 opacity-70 lg:text-[22px]">
                Podejście Skoncentrowane na Kliencie
              </h3>
            </div>
            <p className="mt-[10px] text-[14px] xl:text-lg 2xl:text-lg text-gray-800 opacity-0 group-hover:opacity-100 max-h-0 group-hover:max-h-[80px] overflow-hidden transition-all duration-500 ease-in-out">
          ...
          <li className="group relative flex flex-col justify-between px-[30px] py-[20px] lg:px-[120px] transition-all duration-500 ease-in-out hover:bg-grayLight">
            <div className="flex items-center">
              ...
              <h3 className="ml-[20px] text-[15px] xl:text-lg 2xl:text-lg text-gray-800 opacity-70 lg:text-[22px]">
                Doskonałość w Realizacji
              </h3>
            </div>
            <p className="mt-[10px] text-[14px] xl:text-lg 2xl:text-lg text-gray-900 opacity-0 group-hover:opacity-100 max-h-0 group-hover:max-h-[80px] overflow-hidden transition-all duration-500 ease-in-out">
          ...
          <li className="group relative flex flex-col justify-between px-[30px] py-[20px] lg:px-[120px] transition-all duration-500 ease-in-out hover:bg-grayLight">
            <div className="flex items-center">
              ...
              <h3 className="ml-[20px] text-[15px] xl:text-lg 2xl:text-lg text-gray-900 opacity-70 lg:text-[22px]">
